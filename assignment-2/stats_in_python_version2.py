...
def main():
    ...
    print(f"\n{' ':<4}Column: {sys.argv[2]}")
    print(f"\n\n{' ':<8}{'Count':10}={total_count:>10.3f})")
    print(f"{' ':<8}{'ValidNum':10}={valid_num_count:>10.3f}")
    print(f"{' ':<8}{'Average':10}={average:>10.3f}")
    print(f"{' ':<8}{'Maximum':10}={maximum_value:>10.3f}")
    print(f"{' ':<8}{'Minimum':10}={minimum_value:>10.3f}")
    print(f"{' ':<8}{'Variance':10}={variance:>10.3f}")
    print(f"{' ':<8}{'Std Dev':10}={standard_deviation:>10.3f}")
    print(f"{' ':<8}{'Median':10}={median:>10.3f}\n")
